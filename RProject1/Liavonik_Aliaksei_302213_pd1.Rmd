...
Po napisaniu wszystkich zapytań doszłem do wniosku, że najwygodniej dla mnie pisać korzystająć z biblioteki dplyr, dlatego że daje bardzo dobre wyniki czasowe oraz jest bardziej podobna do innych języków programowania, a w szczególności do SQLa.
